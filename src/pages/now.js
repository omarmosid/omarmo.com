...
const Now = ({ data }) => {
  return (
    <Layout>
      ...
      <Heading as="h2" pb="2em" fontSize="1.2em">This page shows what I have been doing.</Heading>
      <List as="ul">
        <ListItem>
          <span role="img" aria-label="Open book Emoji">📖</span> Reading{" "}
          <Link
        ...
        <ListItem>
          <span role="img" aria-label="Headphone Emoji">🎧</span> Listening to{" "}
          <Link
        ...
        <ListItem>
          <span role="img" aria-label="Videogame controller Emoji">🎮</span> Playing{" "}
          <Link
        ...
        <Text mt="2em">Last updated {data.siteBuildMetadata.buildTime}</Text>
      </List>
    </Layout>
  );
};
